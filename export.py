...
from models.common import Conv, Swish, MemoryEfficientSwish, Concat
from models.yolo import Detect
...
def run(
    ...
    for k, m in model.named_modules():
        if isinstance(m, Conv):
            ...
            if isinstance(m.swish, MemoryEfficientSwish):
                m.swish = Swish()
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'v5s-p6_wider_face.pt',
